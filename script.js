...
// Handles hamburger toggle (mobile) and smooth scroll for nav links
// ===============================
...
async function init() {
  try {
    ...
    document.getElementById("mainContent").innerHTML =
      "<p style='padding:20px'>Menu unavailable</p>";
  }
}
...
// Returns correct image path based on type (product / combo / addon)
...
// Collapsible, includes count badge (fixed!)
// ===============================
